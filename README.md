...
- [Link to Data](https://www.kaggle.com/datasets/bwandowando/spotify-songs-with-attributes-and-lyrics)
...
- Average artist popularity is the dominant predictor across all model specifications
- The fourth-root model achieved the lowest cross validated MAE (~5.0), outperforming both OLS (~13.0) and quasi-Poisson (~13.0)
